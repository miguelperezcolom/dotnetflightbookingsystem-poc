...
{ 
    ...
    { 
        /// <summary>
        /// Gets or Sets AircraftCode
        /// </summary>

        [DataMember(Name="aircraftCode")]
        ...
        public bool Equals(Equipment other)
        {
            ...
            return 
                (
                    AircraftCode == other.AircraftCode ||
                    AircraftCode != null &&
                    AircraftCode.Equals(other.AircraftCode)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AircraftCode.GetHashCode();
                    if (Name != null)
